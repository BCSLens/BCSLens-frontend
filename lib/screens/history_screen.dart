...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  final List<Map<String, dynamic>> _recordHistory = [
    {
  ...
  Widget build(BuildContext context) {
    ...
    for (var record in _recordHistory) {
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  _buildInfoPill('Age', '3 years'),
                  const SizedBox(width: 8),
                  _buildInfoPill('Breed', 'Corgi'),
                  const SizedBox(width: 8),
                  _buildInfoPill('Gender', 'Female'),
                  const SizedBox(width: 8),
                  _buildInfoPill('Birth', '02/08/02'),
                ],
              ),
            ),
          ),
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _selectedTab == 'Records'
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _selectedTab == 'Graphs'
                          ? const Color(0xFF7B8EB5)
                          : Colors.white,
                      elevation: 0,
                      shape: RoundedRectangleBorder(
  ...
  Widget _buildRecordsTab(Map<String, List<Map<String, dynamic>>> groupedRecords) {
